...
const VoiceButton: React.FC<VoiceButtonProps> = ({ 
    ...
    try {
      ...
      if ('SpeechRecognition' in window || 'webkitSpeechRecognition' in window) {
        ...
        recognition.onresult = (event) => {
          ...
          const processedTranscript = convertSpokenPunctuationToSymbols(transcript);
  ...
  const convertSpokenPunctuationToSymbols = (text: string): string => {
    ...
    // Create a regex that matches whole words that are in our punctuation map
    const regex = new RegExp('\\b(' + Object.keys(punctuationMap).join('|') + ')\\b', 'gi');
